...
//    pKNN = createBackgroundSubtractorKNN();
    ...
    BackgroundSubtraction* bs2 = new BackgroundSubtraction();
...
//        ui->lbCameraInfo->setText(cameraWorking);
        ...
        for(;;)
        {
           ...
           // fgMaskKNN = bs->applyKNN(frame, fgMaskKNN);
            //fgMaskGMG = bs2->applyGMG(frame,fgMaskGMG);
           //fgMaskMOG = bs2 ->applyMOG(frame,*fgMaskMOG);
            fgMaskMOG2 = bs2 -> applyMOG2(frame,fgMaskMOG2);
